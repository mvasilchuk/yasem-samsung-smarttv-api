...
if(typeof Common.API.Widget === 'undefined')
{
    Common.API.Widget = (function()
    {
        ...
        Widget.prototype.putInnerHTML = function(element, value)
        {
            element.innerHTML = value;
        }

        Widget.prototype.sendReadyEvent = function()
        {
            console.log("Widget::sendReadyEvent()");
        }

        Widget.prototype.sendExitEvent = function()
        {
            console.log("Widget::sendExitEvent()");
        }

        Widget.prototype.sendReturnEvent = function()
        {
            console.log("Widget::sendReturnEvent()");
        }

        Widget.prototype.blockNavigation = function()
        {
            console.log("Widget::blockNavigation()");
        }

        Widget.prototype.putInnerHTML = function()
        {
            console.log("Widget::putInnerHTML()");
        }
